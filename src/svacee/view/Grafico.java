...
public class Grafico extends javax.swing.JFrame {
    ...
    private List<String> listaPontosColeta; 
    
    
    public Grafico() {

        initComponents();
        listaPontosColeta = new ArrayList();
        
        //Popular a lista de itens para o combo
        
        //ler cada item da Lista de Dados de consumo que veio do CSV (iterator)

        // Se o item (DadoConsumo) (i.next()).getIdPontoColeta() NÂO estiver em listaPontosColeta
        
              ///adiciona o item em listaPontosColeta
    ...
    private void preencheComboPontosColeta() {
